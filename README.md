...
![Solidity Solution Part 1](joint_savings_part1.png)
![Solidity Solution Part 2](joint_savings_part1.png)
...
![Deploy Smart Contract](Images/Screenshot_2022-07-10_124251.png)
...
2. Test the deposit functionality of your smart contract by sending the following amounts of ether. After each transaction, use the `contractBalance` function to verify that the funds were added to your contract:
    ...
    * Transaction 1: Send 1 ether as wei.
    ...
    ![Transaction 1](Images/Screenshot_2022-07-10_165842.png)

    * Transaction 2: Send 10 ether as wei.

    ![Transaction 2](Images/Screenshot_2022-07-10_170152.png)

    * Transaction 3: Send 5 ether.

    ![Transaction 3](Images/Screenshot_2022-07-10_170309.png)
